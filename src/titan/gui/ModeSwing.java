...
public class ModeSwing implements GuiInterface, SwingInterface {
    ...
    public static void main(String[] args){
        ...
        gui.prepareApplication(new Euler(), 86400 * 120, 3600);
    }
    ...
    private void drawState(State s){
        ...
        for(int i = 0; i < objects.length; i++){
            ...
            Vector3dInterface position = p.resizePosition(length);

            int xTopLeft = (int) position.getX() + resolution.width / 2 - radius;
            int yTopLeft = (int) position.getY() + resolution.height / 2 - radius;
