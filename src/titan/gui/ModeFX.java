...
public class ModeFX extends Application implements GuiInterface {
    ...
    public void start(Stage stage){
        prepareApplication(new Euler(), 86400 * 120, 86400);
