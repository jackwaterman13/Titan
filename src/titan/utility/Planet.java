...
public class Planet implements DataInterface, GuiObjectInterface {
     ...
     */
    public Vector3dInterface resizeRelativePosition(double l, Vector3dInterface relativeTo){
        Vector3dInterface result = position.add(relativeTo);
        return result.mul(l / result.norm());
    }
